  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (view === 'signup') {
        ...
        // After signup, user is signed out and verification email is sent
      ...
      // Check for our custom email-not-verified error
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-800 mb-2">Reset Link Sent</h1>
          <p className="text-gray-600 mb-6">
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
          <button
            ...
            className="flex items-center gap-1 text-gray-600 hover:text-gray-800 mb-6 text-sm"
          >
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            {isSignUp ? 'Sign up to start creating quizzes' : 'Sign in to continue'}
          </p>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-2 bg-white border border-gray-300 text-gray-700 py-3 rounded-lg hover:bg-gray-50 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
        >
